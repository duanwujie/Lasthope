...
extern color M1_color = Orange;
extern color M5_color = Orange;
extern color M15_color = Orange;
extern color M30_color = Orange;


extern color M60_color = Red;
extern color M240_color = Yellow;
extern color M1440_color = Lime;
extern color M10080_color = Moccasin;


extern int m1_width = 1;
extern int m5_width = 1;
extern int m15_width = 1;
extern int m30_width = 1;
extern int h1_width = 2;
extern int h4_width = 3;
extern int d1_width = 4;
extern int w1_width = 4;


extern color M240Up_color = White;
...
int init() {
    ...
    SetIndexStyle(0, DRAW_LINE, 0, m1_width, M1_color);
    //============================================================================================
    SetIndexBuffer(1, M5Buffer);
    SetIndexLabel(1, "M5 RSI");
    SetIndexStyle(1, DRAW_LINE, 0, m5_width, M5_color);
    //============================================================================================
    SetIndexBuffer(2, M15Buffer);
    SetIndexLabel(2, "M15 RSI");
    SetIndexStyle(2, DRAW_LINE, STYLE_DASHDOTDOT, m15_width, M15_color);
    //============================================================================================
    SetIndexBuffer(3, M30Buffer);
    SetIndexLabel(3, "M30 RSI");
    SetIndexStyle(3, DRAW_LINE, STYLE_DASHDOTDOT, m30_width, M30_color);
    //============================================================================================
    SetIndexBuffer(4, M60Buffer);
    SetIndexLabel(4, "H1 RSI");
    SetIndexStyle(4, DRAW_LINE, 0, h1_width, M60_color);
    //============================================================================================
    SetIndexBuffer(5, M240Buffer);
    SetIndexLabel(5, "H4 RSI");
    SetIndexStyle(5, DRAW_LINE, 0, h4_width, M240_color);
    //============================================================================================
    SetIndexBuffer(6, M1440Buffer);
    SetIndexLabel(6, "D1 RSI");
    SetIndexStyle(6, DRAW_LINE, 0, d1_width, M1440_color);
    //============================================================================================
    SetIndexBuffer(7, M10080Buffer);
    SetIndexLabel(7, "W1 RSI");
    SetIndexStyle(7, DRAW_LINE, 0, w1_width, M10080_color);
    //============================================================================================


    SetIndexBuffer(8, TrendLevels);
